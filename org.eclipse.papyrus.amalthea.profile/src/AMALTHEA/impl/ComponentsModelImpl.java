 ...
 * </p>
 * <ul>
 *   <li>{@link AMALTHEA.impl.ComponentsModelImpl#getBase_Model <em>Base Model</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentsModelImpl extends MinimalEObjectImpl.Container implements ComponentsModel {
	/**
	...
	protected EClass eStaticClass() {
		return AMALTHEAPackage.Literals.COMPONENTS_MODEL;
	}
		...
		if (base_Model != null && base_Model.eIsProxy()) {
			...
			if (base_Model != oldBase_Model) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AMALTHEAPackage.COMPONENTS_MODEL__BASE_MODEL, oldBase_Model, base_Model));
			}
		}
		return base_Model;
	}
	...
	public void setBase_Model(Model newBase_Model) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AMALTHEAPackage.COMPONENTS_MODEL__BASE_MODEL, oldBase_Model, base_Model));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AMALTHEAPackage.COMPONENTS_MODEL__BASE_MODEL:
