...
public class AMALTHEAPackageImpl extends EPackageImpl implements AMALTHEAPackage {
	 ...
	 * @generated
	 */
	public EReference getComponentsModel_Base_Model() {
	...
	public void createPackageContents() {
		...
		createEReference(componentsModelEClass, COMPONENTS_MODEL__BASE_MODEL);
	...
	public void initializePackageContents() {
		...
		initEReference(getComponentsModel_Base_Model(), theUMLPackage.getModel(), null, "base_Model", null, 1, 1, ComponentsModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEOperation(getPort__ComputeUniqueName(), theTypesPackage.getString(), "computeUniqueName", 1, 1, IS_UNIQUE, !IS_ORDERED);
		...
		initEAttribute(getCustomProperty_Key(), theTypesPackage.getString(), "key", null, 1, 1, CustomProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getCustomProperty_Value(), theUMLPackage.getValueSpecification(), null, "value", null, 1, 1, CustomProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(ecuEClass, AMALTHEA.ECU.class, "ECU", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getECU_EcuType(), this.getECUType(), null, "ecuType", null, 1, 1, AMALTHEA.ECU.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getECU_Microcontrollers(), this.getMicrocontroller(), null, "microcontrollers", null, 0, -1, AMALTHEA.ECU.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
