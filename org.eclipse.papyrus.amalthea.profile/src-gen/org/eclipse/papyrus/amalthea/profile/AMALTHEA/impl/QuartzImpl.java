 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.AMALTHEA.impl.QuartzImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.AMALTHEA.impl.QuartzImpl#getFrequency <em>Frequency</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public Frequency getFrequency() {
		if (frequency != null && frequency.eIsProxy()) {
			...
			if (frequency != oldFrequency) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AMALTHEAPackage.QUARTZ__FREQUENCY, oldFrequency, frequency));
			}
		}
		return frequency;
	}
