 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.AMALTHEA.impl.ComplexNodeImpl#getQuartzes <em>Quartzes</em>}</li>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.AMALTHEA.impl.ComplexNodeImpl#getPrescaler <em>Prescaler</em>}</li>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.AMALTHEA.impl.ComplexNodeImpl#getNetworks <em>Networks</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ComplexNodeImpl extends BlockImpl implements ComplexNode {
	...
	public EList<Quartz> getQuartzes() {
		if (quartzes == null) {
			quartzes = new EObjectResolvingEList<Quartz>(Quartz.class, this, AMALTHEAPackage.COMPLEX_NODE__QUARTZES);
		}
		return quartzes;
	}
		...
		if (prescaler != null && prescaler.eIsProxy()) {
			...
			if (prescaler != oldPrescaler) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AMALTHEAPackage.COMPLEX_NODE__PRESCALER, oldPrescaler, prescaler));
			}
		}
		return prescaler;
	}
	...
	public void setPrescaler(Prescaler newPrescaler) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AMALTHEAPackage.COMPLEX_NODE__PRESCALER, oldPrescaler, prescaler));
	}
	...
	public EList<Network> getNetworks() {
		if (networks == null) {
			networks = new EObjectResolvingEList<Network>(Network.class, this, AMALTHEAPackage.COMPLEX_NODE__NETWORKS);
		}
		return networks;
	}
