 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.AMALTHEA.impl.NetworkTypeImpl#getSchedPolicy <em>Sched Policy</em>}</li>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.AMALTHEA.impl.NetworkTypeImpl#getBitWidth <em>Bit Width</em>}</li>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.AMALTHEA.impl.NetworkTypeImpl#getBase_DataType <em>Base Data Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetworkTypeImpl extends MinimalEObjectImpl.Container implements NetworkType {
	...
	protected EClass eStaticClass() {
		return AMALTHEAPackage.Literals.NETWORK_TYPE;
	}
	...
	public DataType getBase_DataType() {
		if (base_DataType != null && base_DataType.eIsProxy()) {
			...
			if (base_DataType != oldBase_DataType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AMALTHEAPackage.NETWORK_TYPE__BASE_DATA_TYPE, oldBase_DataType, base_DataType));
			}
		}
	...
	public void setBase_DataType(DataType newBase_DataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AMALTHEAPackage.NETWORK_TYPE__BASE_DATA_TYPE, oldBase_DataType, base_DataType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AMALTHEAPackage.NETWORK_TYPE__BIT_WIDTH:
				return getBitWidth();
			case AMALTHEAPackage.NETWORK_TYPE__BASE_DATA_TYPE:
