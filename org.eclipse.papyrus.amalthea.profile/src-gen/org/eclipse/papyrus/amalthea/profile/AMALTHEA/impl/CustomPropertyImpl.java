 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.AMALTHEA.impl.CustomPropertyImpl#getKey <em>Key</em>}</li>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.AMALTHEA.impl.CustomPropertyImpl#getBase_Property <em>Base Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustomPropertyImpl extends MinimalEObjectImpl.Container implements CustomProperty {
	...
	public Property getBase_Property() {
		if (base_Property != null && base_Property.eIsProxy()) {
			...
			if (base_Property != oldBase_Property) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AMALTHEAPackage.CUSTOM_PROPERTY__BASE_PROPERTY, oldBase_Property, base_Property));
			}
		}
	...
	public void setBase_Property(Property newBase_Property) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AMALTHEAPackage.CUSTOM_PROPERTY__BASE_PROPERTY, oldBase_Property, base_Property));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AMALTHEAPackage.CUSTOM_PROPERTY__KEY:
				return getKey();
			case AMALTHEAPackage.CUSTOM_PROPERTY__BASE_PROPERTY:
