 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.AMALTHEA.impl.StimuliModelImpl#getBase_Model <em>Base Model</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StimuliModelImpl extends MinimalEObjectImpl.Container implements StimuliModel {
	/**
	...
	protected EClass eStaticClass() {
		return AMALTHEAPackage.Literals.STIMULI_MODEL;
	}
		...
		if (base_Model != null && base_Model.eIsProxy()) {
			...
			if (base_Model != oldBase_Model) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AMALTHEAPackage.STIMULI_MODEL__BASE_MODEL, oldBase_Model, base_Model));
			}
		}
		return base_Model;
	}
	...
	public void setBase_Model(Model newBase_Model) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AMALTHEAPackage.STIMULI_MODEL__BASE_MODEL, oldBase_Model, base_Model));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AMALTHEAPackage.STIMULI_MODEL__BASE_MODEL:
