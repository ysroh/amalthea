 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.AMALTHEA.impl.SoftwareModelImpl#getBase_Model <em>Base Model</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SoftwareModelImpl extends MinimalEObjectImpl.Container implements SoftwareModel {
	...
	protected EClass eStaticClass() {
		return AMALTHEAPackage.Literals.SOFTWARE_MODEL;
	}
		...
		if (base_Model != null && base_Model.eIsProxy()) {
			...
			if (base_Model != oldBase_Model) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AMALTHEAPackage.SOFTWARE_MODEL__BASE_MODEL, oldBase_Model, base_Model));
			}
		}
		return base_Model;
	}
	...
	public void setBase_Model(Model newBase_Model) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AMALTHEAPackage.SOFTWARE_MODEL__BASE_MODEL, oldBase_Model, base_Model));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AMALTHEAPackage.SOFTWARE_MODEL__BASE_MODEL:
