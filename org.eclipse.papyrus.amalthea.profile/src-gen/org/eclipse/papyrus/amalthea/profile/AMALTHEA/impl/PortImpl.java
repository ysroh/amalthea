 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.AMALTHEA.impl.PortImpl#getBase_Port <em>Base Port</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PortImpl extends ReferableBaseObjectImpl implements Port {
	...
	protected EClass eStaticClass() {
		return AMALTHEAPackage.Literals.PORT;
	}
		...
		if (base_Port != null && base_Port.eIsProxy()) {
			...
			if (base_Port != oldBase_Port) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AMALTHEAPackage.PORT__BASE_PORT, oldBase_Port, base_Port));
			}
		}
		return base_Port;
	}
	...
	public void setBase_Port(org.eclipse.uml2.uml.Port newBase_Port) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AMALTHEAPackage.PORT__BASE_PORT, oldBase_Port, base_Port));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AMALTHEAPackage.PORT__BASE_PORT:
