 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.amalthea.hardware.impl.FrequencyImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.amalthea.hardware.impl.FrequencyImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FrequencyImpl extends MinimalEObjectImpl.Container implements Frequency {
	...
	protected EClass eStaticClass() {
		return HardwarePackage.Literals.FREQUENCY;
	}
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HardwarePackage.FREQUENCY__VALUE, oldValue, value));
	}
	...
	public void setUnit(FrequencyUnit newUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HardwarePackage.FREQUENCY__UNIT, oldUnit, unit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HardwarePackage.FREQUENCY__VALUE:
				return getValue();
			case HardwarePackage.FREQUENCY__UNIT:
				return getUnit();
		}
