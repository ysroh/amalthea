 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.amalthea.components.impl.FInterfacePortImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.amalthea.components.impl.FInterfacePortImpl#getBase_Port <em>Base Port</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FInterfacePortImpl extends MinimalEObjectImpl.Container implements FInterfacePort {
	/**
	...
	protected EClass eStaticClass() {
		return ComponentsPackage.Literals.FINTERFACE_PORT;
	}
	...
	public void setKind(InterfaceKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentsPackage.FINTERFACE_PORT__KIND, oldKind, kind));
	}
	...
	public Port getBase_Port() {
		if (base_Port != null && base_Port.eIsProxy()) {
			...
			if (base_Port != oldBase_Port) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ComponentsPackage.FINTERFACE_PORT__BASE_PORT, oldBase_Port, base_Port));
			}
		}
		return base_Port;
	}
	...
	public void setBase_Port(Port newBase_Port) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentsPackage.FINTERFACE_PORT__BASE_PORT, oldBase_Port, base_Port));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ComponentsPackage.FINTERFACE_PORT__KIND:
				return getKind();
