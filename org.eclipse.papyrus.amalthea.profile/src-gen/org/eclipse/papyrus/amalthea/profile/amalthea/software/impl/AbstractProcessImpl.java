 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.amalthea.profile.amalthea.software.impl.AbstractProcessImpl#getPriority <em>Priority</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractProcessImpl extends AbstractElementMemoryInformationImpl implements AbstractProcess {
	...
	protected EClass eStaticClass() {
		return SoftwarePackage.Literals.ABSTRACT_PROCESS;
	}
	...
	public void setPriority(int newPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SoftwarePackage.ABSTRACT_PROCESS__PRIORITY, oldPriority, priority));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SoftwarePackage.ABSTRACT_PROCESS__PRIORITY:
				return getPriority();
		}
